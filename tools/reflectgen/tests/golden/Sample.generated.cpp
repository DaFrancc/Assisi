...
static const bool _reflectgen_SampleAllTypes = []() -> bool
{
    ...
    Assisi::Core::Reflect::ComponentRegistry::Instance().Register({
        ...
        [](void* scene_ptr, uint32_t entity_index, uint32_t entity_gen, const nlohmann::json& j)
        {
            ...
            T comp{};
            if (!Assisi::Core::Reflect::ReadFloat(j, _comp, "f", comp.f)) return false;
            if (!Assisi::Core::Reflect::ReadDouble(j, _comp, "d", comp.d)) return false;
            if (!Assisi::Core::Reflect::ReadInt32(j, _comp, "i32", comp.i32)) return false;
            if (!Assisi::Core::Reflect::ReadUInt32(j, _comp, "u32", comp.u32)) return false;
            ...
            { float _v[4] = { comp.q.w, comp.q.x, comp.q.y, comp.q.z }; if (!Assisi::Core::Reflect::ReadFloatArray(j, _comp, "q", 4, _v)) return false; comp.q = glm::quat{ _v[0], _v[1], _v[2], _v[3] }; }
            { float _v[16] = { comp.m[0][0], comp.m[0][1], comp.m[0][2], comp.m[0][3], comp.m[1][0], comp.m[1][1], comp.m[1][2], comp.m[1][3], comp.m[2][0], comp.m[2][1], comp.m[2][2], comp.m[2][3], comp.m[3][0], comp.m[3][1], comp.m[3][2], comp.m[3][3] }; if (!Assisi::Core::Reflect::ReadFloatArray(j, _comp, "m", 16, _v)) return false; comp.m = glm::mat4{ _v[0], _v[1], _v[2], _v[3], _v[4], _v[5], _v[6], _v[7], _v[8], _v[9], _v[10], _v[11], _v[12], _v[13], _v[14], _v[15] }; }
