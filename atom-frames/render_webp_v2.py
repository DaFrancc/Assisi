...
WEBP_FRAMES = 64                   # samples over the SAME LOOP_MS (independent of the
                                   # font's N_FRAMES); ~31ms/frame, ~32fps, same loop
D = m.SIZE * SS                    # working canvas size
WEBP_OUT = os.path.join(m.HERE, "atom-spinner-v2.webp")
