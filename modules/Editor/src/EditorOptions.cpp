...
void EditorOptionsPanel::DrawShadowSettings(const Frame &frame)
{
    ...
    ImGui::SetItemTooltip("How soft every spot and point light's shadow edge is, from Point (about a texel) to "
                          "Vogel (the softest, with no grain). Contact hardening only ever widens this.");
